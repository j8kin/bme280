...
final public class Bme280Sensor {
    ...
    // The "id" register (0xD0) contains chip identification number chip_id[7:0],
    // which is 0x60.
    ...
    // The "Control Mesurments" register sets the pressure and temperature data
    // aquisition
    // options of the device.
    // Attention !!!
    // The register needs to be written after changing HUMIDITY_CONTROL for the
    // changes
    // to become effective.
    // |-----------|--------------|------------------------------------------------------|
    ...
    // The "Config" register set the rate, filter and interface options of the
    // device.
